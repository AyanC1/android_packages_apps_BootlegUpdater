...
updates_dir=/data/bootleg_updates
...
adb shell "killall com.bootleggers.bootlegupdater 2>/dev/null"
adb shell "sqlite3 /data/data/com.bootleggers.bootlegupdater/databases/updates.db" \
